...
def find_followers(ego, graph):
    follower_data = get_followers(ego, 100).data
    following_data = get_following(ego, 100).data
...
if __name__ == '__main__':
    ...
    for key in graph.keys():
        color_map.append(color_convert(at.get_political_score(key, 1500)))
